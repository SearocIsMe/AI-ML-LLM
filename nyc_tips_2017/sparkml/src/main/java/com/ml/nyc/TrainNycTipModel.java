...
public class TrainNycTipModel {
    ...
    public static void main(String[] args) {
        ...
        SparkSession sparkSession = SparkSession.builder().appName("train_spark_ramdomforest").config("spark.master", "local").getOrCreate();
        ...
        trainingSet.show();
        System.out.println("----------------- call RF training ----------------- ");
        ...
        predictions.select("VendorID", "tip_amount", "prediction", "PULocationID", "DOLocationID", "passenger_count", "mta_tax", "payment_type",
                "trip_distance","fare_amount","tolls_amount","total_amount",
                "trip_type", "duration", "day_of_week", "weekend", "speed").show(20);
        System.out.println("----------------- prediction ----------------- ");
